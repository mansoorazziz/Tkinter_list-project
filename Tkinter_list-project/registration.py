...
emailLabel=Label(registrationPanel,text='Email',font=('times new roman',12,'bold'),background='gray20',foreground='white')
...
passwordLabel=Label(registrationPanel,text='Password',font=('times new roman',12,'bold'),background='gray20',foreground='white')
...
#
Button(registrationPanel, text="Signup",font=('times new roman',15), command=signup).grid(row=2, column=0,pady=10,columnspan=2)
Button(registrationPanel, text="Login",font=('times new roman',15), command=login).grid(row=2, column=2,pady=10,columnspan=2)
